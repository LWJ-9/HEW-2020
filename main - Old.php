...
$sql = "SELECT pid , uid  FROM thumbup t WHERE pid IN ($in) ORDER BY add_time desc";
$stm = $db->prepare($sql);
$stm->execute($pidarr);
$row_like = $stm->fetchAll(PDO::FETCH_GROUP);
var_dump($row_like);
          ...
          <div class="left_box">
            ...
            <article id="<?=$row_posts["pid"]; ?>">
              ...
              <section class="button_area">
                <i class="far fa-heart fa-2x fa-fw"
              ...
              <section class="liked_text">
                <p class="liked_text_box">
                  Liked by
                  <a class="" title="ranatokmak" href="./user_info.php?user=ranatokmak">
                    ranatokmak
                  </a>
                  and <span>37,284</span> others
                </p>
              </section>
              <div class="comment">
          ...
          <div class="aside">
            <article class="show_self">
              <section class="show_user header">
                <img src="./images/user/<?=$row_self['picture'] ; ?>" alt="">
            ...
            <article class="show_users">
              ...
              <div class="show_user header">
                ...
                <span><?=$row_user["name"]; ?></span>
                <form action="" method="post">
                  <button type="submit" name="followSb" value="<?=$row_user["uid"]; ?>">
                    <i class="fas fa-user-plus fa-2x fa-fw" title="follow"></i>
                  </button>
                </form>
              </div>
              <?php endforeach; ?>
